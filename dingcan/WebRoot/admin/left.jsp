				                   ...
				                   <td class="left">
					                  <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
							              <tr>
							                <td width="140" align="center">
							                    <span style="margin-left: 50px;font-family: 微软雅黑;font-size: 14px;">
							                        <a href="<%=path %>/catelog?type=catelogMana" target="I1" style="color: black;">披萨类型管理</a> <!-- ?是AJAX技术，？后面可以接传递的参数 -->
							                    </span>
							                </td>
							                <td>&nbsp;</td>
							              </tr>
				                   ...
				                   <td class="left">
					                  <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
							              <tr>
							                <td width="140" align="center">
							                    <span style="margin-left: 50px;font-family: 微软雅黑;font-size: 14px;">
							                        <a href="<%=path %>/admin/catelog/catelogAdd.jsp" target="I1" style="color: black;">添加披萨类型</a>
							                    </span>
							                </td>
							                <td>&nbsp;</td>
							              </tr>
				                   ...
				                   <td class="left">
					                  <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
							              <tr>
							                <td width="140" align="center">
							                    <span style="margin-left: 50px;font-family: 微软雅黑;font-size: 14px;">
							                        <a href="<%=path %>/goods?type=goodsMana" target="I1" style="color: black;">披萨信息管理</a>
							                    </span>
							                </td>
							                <td>&nbsp;</td>
							              </tr>
				                   ...
				                   <td class="left">
					                  <table width="100%" height="24" border="0" cellpadding="0" cellspacing="0">
							              <tr>
							                <td width="140" align="center">
							                    <span style="margin-left: 50px;font-family: 微软雅黑;font-size: 14px;">
							                        <a href="<%=path %>/admin/goods/goodsAdd.jsp" target="I1" style="color: black;">披萨信息添加</a>
							                    </span>
							                </td>
							                <td>&nbsp;</td>
							              </tr>
